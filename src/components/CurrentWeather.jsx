...
const CurrentWeather = ( data ) => {
    ...
    return (
        <div className="flex items-center justify-center w-full ">
            <div className="border-2 border-white/50 flex flex-col h-40 w-full items-center justify-center bg-cover bg-center rounded-xl backdrop-blur-2xl font-semibold sm:p-20 p-10">
