        ...
        <div className="flex items-center justify-center">
            <div className="flex flex-col h-40 items-center justify-center bg-cover bg-center rounded-xl backdrop-blur-2xl font-semibold w-fit sm:p-20 p-10">
                <div className="flex flex-row justify-center gap-3">
                    <p className="flex items-center">L:{ parseInt(data.data.low) }°</p>
                    <p className=" md:text-5xl text-4xl">{ parseInt(data.data.curr) }°</p>
                    <p className="flex items-center">H:{ parseInt(data.data.high)}°</p>
                </div>
