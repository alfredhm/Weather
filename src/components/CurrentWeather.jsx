...
const CurrentWeather = ( props ) => {
    return (
        <div className="flex items-center justify-center w-full ">
            <div style={props.background === "transparent" ? { background: "transparent" } : { backgroundImage: `url(${props.background})` }} className="border-2 flex flex-col h-36 sm:h-40 w-full items-center justify-center bg-center bg-cover rounded-xl backdrop-blur-2xl font-semibold sm:p-20 p-10 ">
