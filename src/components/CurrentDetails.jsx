...
const CurrentDetails = (data) => {
  ...
  return (
    <div className="w-full grid justify-center grid-cols-2 details:grid-cols-3 gap-4">
        <div style={data.isDay ? { backgroundColor: "rgb(203 213 225 / 0.2)"} : {backgroundColor: "rgb(100 116 139 / 0.2)"}} className="z-10 rounded-xl w-full aspect-square border-2 border-white/50">
